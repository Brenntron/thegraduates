...
RSpec.describe User, type: :model do
  describe "validations" do
    ...
    it { should allow_value("brenntron").for(:twitter).on(:create) }
    ...
    it "should allow valid values for email" do
      should allow_value("brennan@brennanwilligham.com", "a@b.co.uk", "brennan+hash@example.com").for(:email)
    end
    describe "should not save if email is !unique" do
      it "should have an error message 'has already been taken'" do
